...
const stepIcons = [
    <svg key="0" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    <svg key="1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    <svg key="2" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
    ...
    <svg key="3" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
...
export function JourneySteps() {
    const { t } = useLanguage();
    const h = t.homePage.journeyVisual;
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center mb-8 md:mb-16">
                    ...
                    <h2 className="text-[#1D2030] text-center font-poppins text-[24px] md:text-[34px] font-bold leading-[130%] pb-[16px]">
                        {h.h2Before}{" "}
                        <span className="text-yellow font-poppins text-[24px] md:text-[34px] font-bold leading-[130%]">{h.h2Accent}</span>
                    </h2>
                    <p className="text-[#76797B] text-center font-poppins text-base font-normal leading-6">{h.body}</p>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {h.steps.map((step, idx) => {
                            const isLast = idx === h.steps.length - 1;
                            return (
                                <motion.div
                                    key={idx}
                                ...
                                >
                                    <div className="flex w-[64px] h-[64px] justify-center items-center rounded-[16px] border-4 border-[#F8F9FB] bg-yellow shadow-[0_8px_24px_0_rgba(100,100,150,0.12)] mb-[16px]">
                                        {stepIcons[idx]}
                                    </div>
                                    <h3 className="text-[#323232] text-center font-poppins text-lg font-bold leading-[130%] pb-[12px]">
                                        {step.title}
                                    </h3>
