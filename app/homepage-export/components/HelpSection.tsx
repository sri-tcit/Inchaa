                ...
                >
                    <div className="flex items-center justify-center mb-6">
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 bg-white/70 shadow-sm backdrop-blur-[10px] max-w-max">
                            <span className="text-center text-[#76797B] font-poppins text-sm font-normal leading-[1.5]">{h.eyebrow}</span>
                        </div>
                    </div>
                    <h2 className="text-[#1D2030] text-center font-poppins text-[24px] md:text-[34px] font-bold leading-[130%] pb-[16px]">
                        {h.h2Before}{" "}
                        <span className="ps-3 text-yellow font-poppins text-[24px] md:text-[34px] font-bold leading-[130%]">{h.h2Accent}</span>
                    </h2>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="space-y-4">
                            <h3 className="text-[#323232] font-poppins text-[20px] font-bold leading-[130%]">{h.faqSectionTitle}</h3>
                            {h.faqs.map((faq, idx) => (
                                <motion.div
                                    key={idx}
                                ...
                                >
                                    <button
                                        ...
                                        className="w-full flex justify-between items-start self-stretch px-[24px] py-[20px] text-start cursor-pointer hover:bg-white/80 transition-colors"
                                    >
                                        <span className="text-[#323232] font-poppins text-[16px] font-semibold leading-[130%] pe-4">{faq.question}</span>
                                        <motion.div
                                            initial={false}
                                        ...
                                        {openIndex === idx && (
                                            ...
                                            >
                                                <div className="px-[24px] pb-[20px]">
                                                    <p className="text-[#76797B] font-poppins text-[14px] font-normal leading-[150%]">{faq.answer}</p>
                                                </div>
                                            </motion.div>
                                        )}
                                    </AnimatePresence>
                    ...
                    <motion.div
                        className="w-full lg:col-span-1 rounded-[24px] p-[32px] border border-[rgba(255,255,255,0.4)] bg-[rgba(255,255,255,0.7)] shadow-[0_8px_32px_0_rgba(100,100,150,0.12)] backdrop-blur-[10px]"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.5, delay: 0.2 }}
                    >
                        <h3 className="text-[#323232] font-poppins text-[20px] font-bold leading-[130%] pb-[16px]">{h.needMoreTitle}</h3>
                        <p className="text-[#76797B] font-poppins text-[16px] font-normal leading-[150%] pb-[16px]">{h.needMoreBody}</p>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="flex w-[40px] h-[40px] justify-center items-center rounded-[16px] bg-yellow shrink-0">
                                ...
                                <div className="text-start min-w-0">
                                    <div className="text-[#323232] font-poppins text-[14px] font-semibold leading-[130%] pb-[4px]">{h.emailTitle}</div>
                                    <div className="text-[#76797B] font-poppins text-[12px] font-normal leading-[150%] break-all">{h.emailAddress}</div>
                                </div>
                            </motion.button>
                            <motion.button
                                type="button"
                            ...
                            >
                                ...
                                <div className="text-start">
                                    <div className="text-[#323232] font-poppins text-[14px] font-semibold leading-[130%] pb-[4px]">{h.chatTitle}</div>
                                    <div className="text-[#76797B] font-poppins text-[12px] font-normal leading-[150%]">{h.chatDetail}</div>
                                </div>
                            </motion.button>
                        </div>
                    </motion.div>
