...
const featureIcons = [
    ...
    <svg key="3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <svg key="5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M16 10V16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>,
];

export function AllInOneGrid() {
    const { t } = useLanguage();
    const g = t.homePage.featuresGrid;
                ...
                <div className="text-center mb-8 md:mb-16">
                    <div className="flex items-center justify-center mb-6">
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 bg-white/70 shadow-sm backdrop-blur-[10px] max-w-max">
                            <span className="text-center text-[#76797B] font-poppins text-sm font-normal leading-[1.5]">{g.eyebrow}</span>
                        </div>
                    </div>
                    <h2 className="text-[#1D2030] text-center font-poppins text-[24px] md:text-[34px] font-bold leading-[130%] pb-[16px]">
                        {g.h2Line1}{" "}
                        <span className="text-yellow font-poppins text-[24px] md:text-[34px] font-bold leading-[130%]">{g.h2Accent}</span>
                    </h2>
                    <p className="text-[#76797B] text-center font-poppins text-base font-normal leading-6">{g.body}</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {g.items.map((feature, idx) => (
                        <motion.div
                            key={idx}
                        ...
                        >
                            <div className="flex w-[48px] h-[48px] justify-center items-center rounded-[12px] bg-yellow/10 text-yellow mb-[16px]">
                                {featureIcons[idx]}
                            </div>
