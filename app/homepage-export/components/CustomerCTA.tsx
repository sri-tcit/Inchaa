...
export function CustomerCTA() {
    return (
        ...
        >
            ...
            <button className="flex w-[220px] h-[44px] px-[24px] py-[8px] justify-center items-center rounded-[16px] bg-yellow text-white font-semibold mx-auto cursor-pointer hover:brightness-95 transition-all">
                Get the App
            </button>
        </motion.div>
    );
