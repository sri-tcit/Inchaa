        ...
        <div className="max-w-[1100px] mx-auto px-4 md:px-6">
          ...
          <div className="border-t border-ui-border">
            {homeownerSteps.map((step) => (
              <div
                key={step.num}
                className="grid grid-cols-[64px_1fr] gap-6 py-8 border-b border-ui-border"
              >
                ...
                <div>
                  <div className="flex items-baseline gap-3">
                    <h3 className="text-text-heading text-xl font-bold">{step.title}</h3>
                    {step.subtitle && (
                      <span className="text-text-muted text-xs font-medium">{step.subtitle}</span>
                    )}
                  </div>
                  <p className="mt-2 text-text-muted text-base leading-relaxed max-w-2xl">
                    {step.description}
                  </p>
                </div>
              </div>
      ...
      <section className="bg-bg-base py-16 md:py-24 border-t border-ui-border">
        <div className="max-w-[1100px] mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="bg-bg-card border border-ui-border rounded-lg p-7">
              <p className="text-text-muted text-xs font-bold uppercase tracking-widest mb-4">
                Without Inchaa
              </p>
              <ul className="space-y-3 text-text-muted text-base leading-relaxed">
                {[
                  ...
                  <li key={item} className="flex gap-3">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-ui-border flex-shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-bg-card border border-ui-border rounded-lg p-7">
              ...
              <ul className="space-y-3 text-text-body text-base leading-relaxed">
                {[
        ...
        <div className="max-w-[1100px] mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12">
            <div>
              ...
              <Link
                href="/faqs"
                className="mt-4 inline-block text-sm text-text-muted hover:text-text-heading transition-colors duration-150 underline underline-offset-2"
              >
                See all FAQs →
              </Link>
            </div>
