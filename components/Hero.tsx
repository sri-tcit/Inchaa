...
export function Hero() {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h1 className="max-w-max text-navy text-[32px] md:text-[52px] lg:text-[56px] font-bold leading-[1.08] tracking-tight">
                            {t.hero.h1Part1} <span className="text-yellow">{t.hero.h1Brand}</span>
                        </h1>
                ...
                <div className=" md:flex md:absolute md:bottom-[-100px] md:left-0 w-full z-10 hidden lg:block">
                    ...
                    >
                        <div className="flex flex-col items-center gap-3">
                            <div className="flex w-16 h-16 justify-center items-center rounded-xl bg-yellow shadow-sm">
  ...
  <path d="M5.08752 12.6655H7.2428C7.54908 12.6655 7.79822 12.9139 7.79846 13.2202C7.79846 13.5267 7.54929 13.7759 7.2428 13.7759H5.08752C4.78124 13.7756 4.53284 13.5266 4.53284 13.2202C4.53308 12.9141 4.78138 12.6658 5.08752 12.6655Z" fill="white" stroke="white" strokeWidth="0.0625"/>
                            ...
                            <p className="text-navy text-center text-sm font-semibold">{t.nav.contractors}</p>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <div className="flex w-16 h-16 justify-center items-center rounded-xl bg-yellow shadow-sm">
                            ...
                            <p className="text-navy text-center text-sm font-semibold">{t.nav.consultants}</p>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <div className="flex w-16 h-16 justify-center items-center rounded-xl bg-yellow shadow-sm">
                            ...
                            <p className="text-navy text-center text-sm font-semibold">{t.nav.engineers}</p>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <div className="flex w-16 h-16 justify-center items-center rounded-xl bg-yellow shadow-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none">
                            ...
                            <p className="text-navy text-center text-sm font-semibold">{t.nav.suppliers}</p>
                        </div>
                    </motion.div>
                </div>
            </div>
