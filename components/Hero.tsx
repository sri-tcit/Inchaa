...
export function Hero() {
    ...
    return (
        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-[url('/assets/hero-banner-overlay.png')] bg-cover bg-center">
            ...
            <div className="relative top-0 left-0 w-full h-full -z-10">
                <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-blue-tint/80 blur-3xl opacity-70 mix-blend-multiply filter" />
                <div className="absolute top-[20%] left-[-10%] w-[400px] h-[400px] rounded-full bg-light-grey blur-3xl opacity-80 mix-blend-multiply filter" />
            </div>
            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#E5E7EB] bg-white/90 shadow-sm max-w-max">
                            <span className="flex h-2 w-2 rounded-full bg-yellow shrink-0" />
                            <span className="text-mid-grey text-sm leading-normal">Building the future of construction</span>
                        </div>

                        <h1 className="max-w-max text-navy text-[32px] md:text-[52px] lg:text-[56px] font-bold leading-[1.08] tracking-tight">
                            Build smarter with <span className="text-yellow">Inchaa</span>
                        </h1>

                        <p className="text-mid-grey text-base md:text-lg leading-relaxed w-full max-w-[628px]">
                            Inchaa is a digital platform that connects customers with verified contractors, engineers, and consultants. Find trusted professionals, request quotations, and manage projects in one place.
                        </p>

                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2 w-full">
                            <PostProjectButton campaign="homepage_hero" size="lg" className="w-full sm:w-auto justify-center">
                                Post your project free
                            </PostProjectButton>
                            <Link
                                href="#platform-video"
                                className="inline-flex items-center justify-center gap-2 min-h-[44px] px-8 rounded-lg w-full sm:w-auto border border-navy/15 bg-white text-navy text-base font-semibold hover:bg-light-grey/80 transition-colors duration-150"
                            >
                                <Play className="w-4 h-4 shrink-0 fill-current" aria-hidden />
                                Watch overview
                            </Link>
                        </div>

                        <div className="flex items-start flex-col gap-4 mt-6 text-sm">
                            <p className="text-mid-grey flex flex-wrap items-center gap-2 text-base leading-relaxed">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className="shrink-0 text-orange">
                                    <g clipPath="url(#clip0_1_2946)">
                                        <path d="M10 1L12.5 6.5L18.5 7.5L14.5 11.5L15.5 18L10 15L4.5 18L5.5 11.5L1.5 7.5L7.5 6.5L10 1Z" fill="currentColor" stroke="currentColor" />
                                    </g>
                                    <defs>
                                ...
                                Trusted across the UAE <span className="font-semibold text-charcoal">5M+</span> users
                            </p>
  ...
  />
                                ...
                                <div className="w-10 h-10 rounded-full border-2 border-white bg-yellow flex items-center justify-center text-white text-sm font-bold">
                                    5k+
                                </div>
                            </div>
                        </div>
                ...
                <div className=" md:flex md:absolute md:bottom-[-100px] md:left-0 w-full z-10 hidden lg:block">
                    <motion.div
                        ...
                        className="flex flex-row items-center justify-center gap-4 md:gap-[100px] p-6 md:p-12 max-w-4xl mx-auto rounded-2xl border border-[#E5E7EB] bg-white/95 shadow-sm backdrop-blur-sm"
                    >
                        <div className="flex flex-col items-center gap-3">
                            <div className="flex w-16 h-16 justify-center items-center rounded-xl bg-navy shadow-sm">
                            ...
                            <p className="text-navy text-center text-sm font-semibold">Customers</p>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <div className="flex w-16 h-16 justify-center items-center rounded-xl bg-navy shadow-sm">
  ...
  <path d="M10.5563 20.564H12.7115C13.0178 20.564 13.267 20.8124 13.2672 21.1187C13.2672 21.4251 13.018 21.6743 12.7115 21.6743H10.5563C10.25 21.6741 10.0016 21.425 10.0016 21.1187C10.0018 20.8125 10.2501 20.5642 10.5563 20.564Z" fill="white" stroke="white" strokeWidth="0.0625"/>
  <path d="M5.08752 20.564H7.2428C7.54908 20.564 7.79822 20.8124 7.79846 21.1187C7.79846 21.4251 7.54929 21.6743 7.2428 21.6743H5.08752C4.78124 21.6741 4.53284 21.425 4.53284 21.1187C4.53308 20.8125 4.78139 20.5642 5.08752 20.564Z" fill="white" stroke="white" strokeWidth="0.0625"/>
  <path d="M10.5563 24.3062H12.7115C13.0178 24.3062 13.267 24.5546 13.2672 24.8608C13.2672 25.1673 13.018 25.4165 12.7115 25.4165H10.5563C10.25 25.4163 10.0016 25.1672 10.0016 24.8608C10.0018 24.5547 10.2501 24.3064 10.5563 24.3062Z" fill="white" stroke="white" strokeWidth="0.0625"/>
  <path d="M5.08752 24.3062H7.2428C7.54908 24.3062 7.79822 24.5546 7.79846 24.8608C7.79846 25.1673 7.54929 25.4165 7.2428 25.4165H5.08752C4.78124 25.4163 4.53284 25.1672 4.53284 24.8608C4.53308 24.5547 4.78139 24.3064 5.08752 24.3062Z" fill="white" stroke="white" strokeWidth="0.0625"/>
  <path d="M10.5563 16.6577H12.7115C13.0178 16.6577 13.267 16.9061 13.2672 17.2124C13.2672 17.5189 13.018 17.7681 12.7115 17.7681H10.5563C10.25 17.7678 10.0016 17.5187 10.0016 17.2124C10.0018 16.9063 10.2501 16.658 10.5563 16.6577Z" fill="white" stroke="white" strokeWidth="0.0625"/>
  <path d="M5.08752 16.6577H7.2428C7.54908 16.6577 7.79822 16.9061 7.79846 17.2124C7.79846 17.5189 7.54929 17.7681 7.2428 17.7681H5.08752C4.78124 17.7678 4.53284 17.5187 4.53284 17.2124C4.53308 16.9063 4.78138 16.658 5.08752 16.6577Z" fill="white" stroke="white" strokeWidth="0.0625"/>
  <path d="M10.5563 12.6655H12.7115C13.0178 12.6655 13.267 12.9139 13.2672 13.2202C13.2672 13.5267 13.018 13.7759 12.7115 13.7759H10.5563C10.25 13.7756 10.0016 13.5266 10.0016 13.2202C10.0018 12.9141 10.2501 12.6658 10.5563 12.6655Z" fill="white" stroke="white" strokeWidth="0.0625"/>
  <path d="M5.08752 12.6655H7.2428C7.54908 12.6655 7.79822 12.9139 7.79846 13.2202C7.79846 13.5267 7.54929 13.7759 7.2428 13.7759H5.08752C4.78124 13.7756 4.53284 13.5266 4.53284 13.2202C4.53308 12.9141 4.78138 12.6658 5.08752 12.6655Z" fill="white" stroke="white" strokeWidth="0.0625"/>
                            ...
                            <p className="text-navy text-center text-sm font-semibold">Contractors</p>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <div className="flex w-16 h-16 justify-center items-center rounded-xl bg-navy shadow-sm">
                            ...
                            <p className="text-navy text-center text-sm font-semibold">Consultants</p>
                        </div>
                    </motion.div>
                </div>
            </div>
