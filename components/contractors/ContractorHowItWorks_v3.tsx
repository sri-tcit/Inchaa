...
function IconQuotes() {
  return (
    <svg viewBox="0 0 44 44" fill="none" className="w-full h-full">
      {/* Three staggered incoming bars — like competing proposals */}
      ...
      {/* Small shield badge on top-right bar */}
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Review pricing, credentials, and past work in one place. No more chasing on WhatsApp.",
  },
  {
    num: "04",
    Visual: IconHire,
...
export function ContractorHowItWorks_v3() {
  return (
    <section className="bg-white py-20 md:py-28">
      <div className="max-w-[1000px] mx-auto px-6 md:px-10">
        ...
        >
          ...
          <h2 className="text-navy text-3xl md:text-[44px] font-bold leading-tight max-w-lg">
            How It Works
          </h2>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 shrink-0">
                    <div className="w-11 h-11 rounded-full border-2 border-yellow bg-white flex items-center justify-center group-hover:bg-yellow transition-colors duration-300">
