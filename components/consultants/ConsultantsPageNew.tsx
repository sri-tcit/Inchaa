    ...
    <section className="bg-white border-t border-[#E5E7EB] py-20 md:py-28">
      <div className="max-w-[1180px] mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-navy text-3xl md:text-[42px] font-bold leading-tight tracking-tight">
            {t.common.seePlatform}
          </h2>
          <p className="mt-4 text-mid-grey text-base leading-relaxed max-w-xl mx-auto">
            {t.consultants.videoDesc}
          </p>
        </div>

        <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-[#1A1A1A] aspect-video">
          {playing ? (
            <video
              ...
              controls
              playsInline
              src="/assets/videos/dashboard-demo.mp4"
            />
          ) : (
            <>
              <img
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                ...
                >
                  <span className="w-0 h-0 border-t-[7px] border-t-transparent border-l-[12px] border-l-[#1A1A1A] border-b-[7px] border-b-transparent ml-1" />
                  {t.common.watchDemo}
                </button>
...
/* ─── Main Export ─── */
export function ConsultantsPageNew() {
  const { t } = useLanguage();

  const feature1 = t.consultants.feature1;
  const feature2 = t.consultants.feature2;
  const steps = t.consultants.steps;
  const faqs = t.consultants.faqs;
  const story = t.consultants.story;
  ...
  const CONSULTANT_TYPES = [
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=600&h=400&fit=crop&q=80",
    },
    {
      slug: "supervision-consultants",
      img: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&h=400&fit=crop&q=80",
    },
  ];
  ...
  return (
    <>
      ...
      <FeatureShowcase
        data={feature1}
        image="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=900&h=700&fit=crop&q=85"
        campaign="consultants_feature"
      />
        ...
        <div className="max-w-[1180px] mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <p className="mt-5 text-mid-grey text-base leading-relaxed">
                {story.body}
              </p>
              ...
              <div className="mt-8">
                <PostProjectButton campaign="consultants_story" size="md">
                  {t.common.postProjectFree}
                </PostProjectButton>
              </div>
            </div>
            <div className="overflow-hidden rounded-2xl shadow-xl">
              <img
                src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=900&h=640&fit=crop&q=85"
                alt="Client meeting with consultant"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-12 lg:gap-24">
            <div>
              ...
              <p className="mt-4 text-mid-grey text-base leading-relaxed">
                {t.consultants.hiwIntro}
              </p>
              <div className="mt-8">
                <PostProjectButton campaign="consultants_hiw" size="md">
                  {t.common.postProjectFree}
                </PostProjectButton>
              </div>
            </div>
            <div className="border-t border-[#E5E7EB]">
              {steps.map((step) => (
                <div
                  key={step.num}
                  className="grid grid-cols-[56px_1fr] gap-5 py-8 border-b border-[#E5E7EB]"
                >
                  <span className="text-[42px] font-black text-[#E0E0DE] leading-none select-none">
                    {step.num}
                  </span>
                  <div className="pt-1">
      ...
      <section className="bg-white border-t border-[#E5E7EB] py-20 md:py-24">
        <div className="max-w-[1180px] mx-auto px-4 md:px-8">
          ...
          <h2 className="text-navy text-3xl md:text-[40px] font-bold leading-tight tracking-tight mb-10">
            {t.consultants.typesHeadline}
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {t.consultants.types.map((type, i) => (
              <Link
                key={CONSULTANT_TYPES[i].slug}
                href={`/consultants/types/${CONSULTANT_TYPES[i].slug}/`}
                className="group relative overflow-hidden rounded-2xl border border-[#E5E7EB] hover:border-navy hover:shadow-md transition-all duration-200"
              >
                <div className="overflow-hidden">
                  <img
                    src={CONSULTANT_TYPES[i].img}
                    alt=""
