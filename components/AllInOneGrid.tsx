                    ...
                    {features.map((feature, idx) => {
                        return (
                            <motion.div
                                ...
                                className="p-8 rounded-2xl border border-[#E5E7EB] bg-white shadow-sm transition-shadow duration-300 hover:shadow-md"
                            >
                                <div className="flex w-12 h-12 justify-center items-center rounded-xl bg-yellow/10 text-yellow mb-4">
                                    {
                                        feature.icon
                                    }
                                </div>
                                <h3 className="text-navy text-lg font-semibold leading-snug pb-3">{feature.title}</h3>
