    ...
    <section className="bg-white py-16 md:py-20">
      <div className="max-w-[1320px] mx-auto px-4 md:px-6">
        <h2 className="text-navy text-lg md:text-xl font-bold">
          Looking for contractors or consultants instead?
        </h2>
        <p className="mt-2 text-mid-grey text-sm leading-relaxed max-w-2xl">
          Inchaa also connects you with contractors, project management consultants,
          quantity surveyors, and design consultants across the UAE.
        </p>
